...
отваря pull request, който човек преглежда и слива. Придвижва се същият подписан
...
- Първоначалното зареждане с `kubectl apply -f bootstrap/` се изпълнява при
  пускането на инфраструктурата от `diplomna-rabota-infra` (след ArgoCD и
  Kyverno); root приложението създава останалите по модела app-of-apps.
